...
//     anagrams('laser', ['lazing', 'lazy',  'lacer']) => []
    ...
    // const checker = (word, current) => {
    //
    // }
    //
    // const anagrams = (word, words) =>
    //     words.filter(current => word.length === current.length)
    //         .map(current=>current.find(letter))
    //
    //
    // console.log(anagrams('abba', ['aabb', 'abcd', 'bbaa', 'dada', 'bbaaa']));
